<?php if( isset($contact) ) : ?>
    ...
    <div class="contacts">
        ...
        <?php if(isset($errorMsg)):  ?>
            <div class="message edit-message <?php echo $this->var_check($succ_or_err); ?> position-relative">
        ...
        <form id="edit-contact" action="<?php echo BASE_URL.'contacts/edit/'.$contact->ID; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        if(isset($cities)) {
                            foreach($cities as $city) {
                                if( isset($_POST['city']) && $_POST['city'] == $city->id ) {
                                    $selected = 'selected="selected"';

                                } elseif(!isset($_POST['city']) && $contact->id_grada == $city->id) {
                                    $selected = 'selected="selected"';
